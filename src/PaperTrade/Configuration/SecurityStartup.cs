...
using PaperTrade.Domain.Services;
...
using AuthenticationService = PaperTrade.Domain.Services.AuthenticationService;
using IAuthenticationService = PaperTrade.Domain.Services.Interfaces.IAuthenticationService;
